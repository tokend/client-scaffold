<template>
  <div class="md-layout md-alignment-center-right" :class="{ 'editable-input-field__nowrap' : nowrap }">
    <template>
      <md-field
        class="field"
    ...
    <template v-if="showIcons">
      <div class="edit">
        <md-button v-if="!allowToEdit" class="md-icon-button" @click="startEdit" :disabled="!canBeEditable">
          <md-icon :style="iconSize ? `font-size: ${iconSize}px !important` : ''" >edit</md-icon>
        </md-button>
        <template v-if="allowToEdit">
          <div class="md-layout" :class="{ 'editable-input-field__nowrap' : nowrap}">
            <md-button class="md-icon-button" @click="changeValue">
              <md-icon :style="iconSize ? `font-size: ${iconSize}px !important` : ''" >done</md-icon>
            </md-button>
            <md-button class="md-icon-button" @click="finishEdit">
