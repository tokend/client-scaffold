<template>
  <div>
    ...
    <detail :prop="i18n.lbl_sender_fee()" :value="tx.fees.source"/>
    <detail :prop="i18n.lbl_recipient_fee()" :value="tx.fees.destination"/>
    <detail :prop="i18n.lbl_fee_from_source()" :value="tx.sourcePaysForDest"/>
    <detail :prop="i18n.lbl_sender_fee_asset()" :value="tx.sourceFeeAsset"/>
    <detail :prop="i18n.lbl_recipient_fee_asset()" :value="tx.destinationFeeAsset"/>
