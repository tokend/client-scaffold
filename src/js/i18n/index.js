...
import labelsRU from './views/ru/labels'
import fileUploadRU from './views/ru/file-upload'
import commonRU from './views/ru/common'
import formConfirmationRU from './views/ru/form_confirmation_view'
import sidebarViewRU from './views/ru/sidebar_view'
import docsRU from './views/ru/docs'
...
const LOCALE = localStorage.getItem('divs-locale') || 'en'
